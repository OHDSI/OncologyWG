...
lab_values as (
  ...
  percentile_cont(0.5) within group (order by value_as_number) over (partition by measurement_concept_id, unit_concept_id, range_low, range_high, value_as_concept_id) as median,
  percentile_cont(0.75) within group (order by value_as_number) over (partition by measurement_concept_id, unit_concept_id, range_low, range_high, value_as_concept_id) as p_75,
  percentile_cont(0.97) within group (order by value_as_number) over (partition by measurement_concept_id, unit_concept_id, range_low, range_high, value_as_concept_id) as p_97,
  count(value_as_number) over (partition by measurement_concept_id, unit_concept_id, range_low, range_high, value_as_concept_id) as cnt
  from (
